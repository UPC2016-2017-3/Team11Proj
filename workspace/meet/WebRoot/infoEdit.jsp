...
<title><s:if test="#attr.info!=null && #attr.info.info_id!=0">编辑</s:if><s:else>发布</s:else>网站公告</title>
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">网站公告管理&gt;&gt;<s:if test="#attr.info!=null && #attr.info.info_id!=0">编辑</s:if><s:else>发布</s:else>网站公告</span>
</div>
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.infos!=null">编辑</s:if><s:else>发布</s:else>网站公告</TD>
