...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">网站公告管理&gt;&gt;查询网站公告</span>
</div>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          <td align="center" style="padding-right:5px">
          	...
          	发布时间：<s:property value="%{#attr.info.info_dateDesc}"/> 
          </td>
        </tr> 
        <tr> 
