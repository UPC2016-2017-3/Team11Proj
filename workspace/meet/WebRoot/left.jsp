				...
				<div id="container">
				  ...
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><div><img height="5" width="190" src="images/menu_topline.gif"></div></td>
					  </tr>
					</table>
					<ul class="MM">
				  ...
				  <h1 class="type"><a href="javascript:void(0)">会议室管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listReservesSum2.action" target="MainFrame">会议室查询</a></li>
					  <li><a href="Admin_listRooms.action" target="MainFrame">会议室信息</a></li>
					  <li><a href="Admin_addRoomShow.action" target="MainFrame">新增会议室</a></li>
					</ul>
				  </div>
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listReserves.action" target="MainFrame">会议室预约查询</a></li>
					  <li><a href="Admin_addReserveShow2.action" target="MainFrame">新增会议室预约</a></li>
					</ul>
				  </div>
				  </c:if>
				  <c:if test="${admin.userType==1}">
				  <h1 class="type"><a href="javascript:void(0)">会议室查询</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listReserves.action" target="MainFrame">会议室预约查询</a></li>
					  <li><a href="Admin_addReserveShow.action" target="MainFrame">新增会议室预约</a></li>
					</ul>
				  </div>
				  </c:if>
